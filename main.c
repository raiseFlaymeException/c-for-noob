...
int main() {
    cfn_init_default_config(); // create default config (all field of cfn_config need to be feeled
                               // and it's a great we to do it)
    ...
    cfn_print_capture_ptr(); // print all pointers allocated in a table see (cfn_test.txt) and if
